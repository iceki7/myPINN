...
class PhysicsInformedNN:
    ...
    def __init__(self, x, y,z, t, u, v,w, layers):
        ...
        # placeHolder都是之后需要用dict输入的量（训练数据）
   ...
   #网络初始化 
    ...
    def net_NS(self, x, y,z, t):
        ...
        u_z = tf.gradients(w, z)[0]    
        u_zz = tf.gradients(w_z, z)[0]    
        ...
        v_z = tf.gradients(w, z)[0]    
        v_zz = tf.gradients(w_z, z)[0]    
...
if __name__ == "__main__": 
      ...
      #3D版的改进：
      #     输出u,v,w,p
      #     将divergence-free作为一个pde loss，取消硬约束
    ...
    t_star=scipy.io.loadmat('../Data/time.mat')['time']#1 T
